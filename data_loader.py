...
class Utterances(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return wav_mono, spk_id_org, spmel, content_input, pitch_input
...
class Collator(object):
    ...
    def __call__(self, batch):
        ...
        for token in batch:
            ...
            new_batch.append( (spk_id_org, spmel_gt, content_input, pitch_input, len_crop) ) 
            
        batch = new_batch  
        spk_id_org, spmel_gt,  content_input, pitch_input, len_crop = zip(*batch)
        ...
        return spk_id_org, spmel_gt,  content_input, pitch_input,  len_crop
