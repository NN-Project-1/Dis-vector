        ...
        for i in range(start_iters, self.num_iters):
            ...
            if self.model_type == 'G':
               ...
               #RR
                ...
                content_pitch_input_intrp = self.Interp(content_pitch_input, len_crop)
                pitch_input_intrp = quantize_f0_torch(content_pitch_input_intrp[:, :, -1])[0]                 
                content_pitch_input_intrp = torch.cat((content_pitch_input_intrp[:,:,:-1], pitch_input_intrp), dim=-1) 
